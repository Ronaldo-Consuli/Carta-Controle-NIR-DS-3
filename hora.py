"""
Carta controle NIR DS-3 — comparação NIR x Método Convencional (Ref)
=================================================================================
...
3. Aplica limites fixos por produto/ensaio quando cadastrados; nos demais casos, calcula LIC/LSC por Carta I (amplitude móvel).
...
# -----------------------------------------------------------------------------
# Limites fixos por produto / ensaio
# -----------------------------------------------------------------------------
...
def html_header(produto: str, ensaio: str, unidade: str, periodo_txt: str, n: int, aba: str) -> str:
    ...
    <div class="qmp-header">
      <div class="qmp-header-texto">
        <div class="qmp-titulo">Carta controle NIR DS-3</div>
      </div>
    </div>
    """
...
<title>Carta controle NIR DS-3</title>
<style>
...
def main() -> None:
    st.set_page_config(page_title="Carta controle NIR DS-3", page_icon="📈", layout="wide")
